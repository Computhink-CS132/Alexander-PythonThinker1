...
start_amt = input("What is the starting ammount of money?")
...
days = int(input("How many days you saved?"))
...
for i in range(1,days+1):
    ...
    start_amt = int(start_amt) + i

    print("Day " + str(i) + ": $" + str(start_amt ))
...
print("Total amount saved = $" +str(start_amt))